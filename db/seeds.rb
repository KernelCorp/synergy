...
pref6.preference_result_criteriums.create correct_answer: 'B', preference_profession: pp41ProfessionType.create name: 'Человек-Природа', description: 'все профессии, связанные с растениеводством, животноводством и лесным хозяйством, минералогией и другими полезными ископаемыми, водными ресурсами.'
